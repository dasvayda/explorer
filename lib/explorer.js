...
module.exports = {
  ...
  //      console.log('prepare_vout:' + i + ':' + txid);
     ...
     //   console.log('prepare_vout>' + 'no address, move to next vout');
   //     console.log('prepare_vout>' + vout[i].scriptPubKey.type);
        loop.next();
      }
    }, function(){
      if (vout[0].scriptPubKey.type == 'nonstandard') {
     //   console.log('function()>' + vout[0].scriptPubKey.type);
